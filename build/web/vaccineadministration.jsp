        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Add Vaccinated Person</h3>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="administration.jsp">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail3" placeholder="NIN Number" name="nin">
                      </div>
                         <div class="form-group">
                        <label for="exampleInputEmail3">Email</label>
                        <input type="email" class="form-control" id="exampleInputEmail3" placeholder="Patient email" name="email">
                      </div>
                        <div class="form-group">
                      ...
                      <div class="form-group">
                              <label for="exampleInputEmail3">Next Dose(Use current date for single doses)</label>
                        <input type="date" required="required" class="form-control" id="exampleInputEmail3" placeholder="Leave blank if their is no next dose" name="date">
                      </div>
